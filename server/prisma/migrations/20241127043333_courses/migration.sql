...
-- CreateIndex
CREATE UNIQUE INDEX "_EnrollmentToProgress_AB_unique" ON "_EnrollmentToProgress"("A", "B");
...
-- AddForeignKey
ALTER TABLE "_EnrollmentToProgress" ADD CONSTRAINT "_EnrollmentToProgress_A_fkey" FOREIGN KEY ("A") REFERENCES "Enrollment"("id") ON DELETE CASCADE ON UPDATE CASCADE;
